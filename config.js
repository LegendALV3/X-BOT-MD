...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:807e9f1cd6cd8711e731532f332afe46";
const SUDO = process.env.SUDO || "919403621818";
...
const BOT_INFO = process.env.BOT_INFO || "QUEEN SAVAGE;https://i.imgur.com/r3GZeiX.jpeg";
...
const STICKER_DATA = process.env.STICKER_DATA || "Legend";
